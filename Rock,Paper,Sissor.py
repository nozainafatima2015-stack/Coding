...
class RpsGame():
    def __init__(self):
        ...
        self.paper_button = button(340, 520,(340,520),300, 140)
        self.scissor_button = button(640, 520,(650,520),300, 140)
        ...
        def player(self):
            ...
            elif self.paper_button.clicked(340):
                self.p_option = "paper"
                self.screen.blit(self.choose_paper, (120, 200))
            else:
                self.scissor_button.clicked(640)
